    ...
    dashboardBody(
        ...
        tabItems(
          tabItem (tabName = "intro",
                   fluidRow(column(1), tags$img(src='obesity.png')),
          ...
          tabItem(tabName = "y_gen_trend",
                  fluidRow(box(title = "Youth Obesity vs Diet", "US States data across year (2001, 2003, 2005, 2007, 2009, 2011, 2013, 2015)", width = 12)),
                  fluidRow(box(plotOutput("Y_trend_fru"), width = 6),
                           box(plotOutput("Y_trend_veg"), width = 6)),
                  br(),
                  fluidRow(box(title = "Youth Obesity vs Physical Activity", "US States data across years (2001, 2003, 2005, 2007, 2009, 2011, 2013, 2015)", width = 12)),
                  fluidRow(box(plotOutput("Y_trend_pa1"), width = 6),
                           box(plotOutput("Y_trend_pa2"), width = 6))),
          tabItem(tabName = "a_gen_trend",
                  fluidRow(box(title = "Adult Obesity vs Diet", "US States data across years (2011, 2012, 2013, 2014, 2015, 2016)", width = 12)),
                  fluidRow(box(plotOutput("A_trend_fru"), width = 6),
                           box(plotOutput("A_trend_veg"), width = 6)),
                  br(),
                  fluidRow(box(title = "Adult Obesity vs Physical Activity", "US States data across years (2011, 2012, 2013, 2014, 2015, 2016)", width = 12)),
